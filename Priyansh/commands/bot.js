...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "bot chutiya") || (event.body.toLowerCase() == "lanti")) {
     return api.sendMessage("Hmm... Tu chutiya tera khandan chutiya chala Ja BHsdK 🐂😾 :))", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "create you")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:[ . ] • 𒁍≛⃝𝗦𝗔𝗠𝗘𝗘𝗥 𝗞𝗛𝗔𝗡●☆●🥀💔🪽 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐌𝐫𝗦𝗮𝗺𝗲𝗲𝗿. 𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :-https://www.facebook.com/share/1565f1q9U4/  Contact Him  :- 𝕤𝕒𝕞𝕖𝕖𝕣 𝕜𝕙𝕒𝕟", threadID);
   };
